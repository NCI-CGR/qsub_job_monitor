...
void qsub_job_monitor::cargs::initialize_options() {
  _desc.add_options()("help,h", "emit this help message")(
      ...
      "prefix of all qsub output files")(
      "job-name,j",
      ...
      boost::program_options::value<std::string>()->default_value(
          "h_rt=2:00:00"),
      "resource request to qsub")(
      "queue,q",
      boost::program_options::value<std::string>()->default_value("all.q"),
      "qsub queue")("command-script,c",
      ...
      boost::program_options::value<unsigned>()->default_value(10),
      "number of times to attempt qstat before killing process")(
      "eqw-resub-limit,e",
      boost::program_options::value<unsigned>()->default_value(3),
      "number of times to attempt resubbing Eqw job before killing process");
}
